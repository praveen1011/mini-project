...
query = query.replace("#cl1","a1" + sub);
query = query.replace("#cl2","a2" + sub );
query = query.replace("#cl3","m1" + sub);
out.println("<p>"+query+"</p>");
String intquery = "insert into #tbl (#cl1,#cl2,#cl3) values (?,?,?)";
intquery = intquery.replace("#tbl",table);
intquery = intquery.replace("#cl1","a1" + sub);
intquery = intquery.replace("#cl2","a2" + sub );
intquery = intquery.replace("#cl3","m1" + sub);
out.println("<p>"+intquery+"</p>");
String upquery = "UPDATE #tbl SET #cl1=?,#cl2=?,#cl3=? where rolno=?";
upquery = upquery.replace("#tbl",table);
upquery = upquery.replace("#cl1","a1" + sub);
upquery = upquery.replace("#cl2","a2" + sub );
upquery = upquery.replace("#cl3","m1" + sub);
