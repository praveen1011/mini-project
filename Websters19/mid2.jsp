...
String Tablename = "m2" + branch + String.valueOf(sem) + String.valueOf(fro) + String.valueOf(to);
...
%>
<tr>
<td><%=resultSet.getString("ROLNO")%></td>
<td><%=resultSet.getString("NAME")%></td>
<%
roll.add(resultSet.getString("ROLNO"));
name.add(resultSet.getString("NAME"));
st0.setString(1,resultSet.getString("ROLNO"));
...
st2.setString(1,resultSet.getString("ROLNO"));
